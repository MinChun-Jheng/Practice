...
def create_grid(locked_pos={}):
    grid = [[(0,0,0) for _ in range(10)] for _ in range(20)] # 10 x 20 block with color(,,)
...
def valid_space(shape, grid):
    ...
    # get [[(0,0), (1,0), ...] ... [(8,19), (9,19)]]
    accepted_pos = [j for sub in accepted_pos for j in sub]
    # transform to 1D array [(0,0), (1,0), ...,  (8,19), (9,19)]
...
def draw_grid(surface, grid):
    sx = top_left_x
    sy = top_left_y
    # draw 20 vertical line, 10 horizontal line
    for i in range(len(grid)):
